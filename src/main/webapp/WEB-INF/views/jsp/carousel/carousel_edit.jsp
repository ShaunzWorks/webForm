...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="carousel.title"/></h2>
       	<form id="carouselEditForm" enctype="multipart/form-data">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="name" name="name" placeholder="<spring:message code="carousel.name.placeHolder"/>" value="${carousel.name}"/>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="header" name="header" placeholder="<spring:message code="carousel.header.placeHolder"/>" value="${carousel.header}"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
		  ...
		  <div class="form-group row">
            ...
            <div class='input-group date col-sm-6' id='datetimepickerPostTime'>
               	<input type="text" class="form-control" id="postTime" name="postTime" placeholder="<spring:message code="carousel.header.placeHolder"/>" value="${carousel.postTime}"/>
                <span class="input-group-addon">
		  ...
		  <div class="form-group row">
		  	...
		  	<div class="input-group col-sm-6">
	  		    <textarea id="content" name ="content" class="form-control" rows="10" placeholder="Enter text ...">${carousel.content}</textarea>
		  	</div>
		  	<div class="col-sm-4">
		    	<span></span>
		    </div>
