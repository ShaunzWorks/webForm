...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="user.grant.title"/> ${carousel.name}(${carousel.id})</h2>
  	...
  	<script type="text/javascript" >
		...
		$(function(){
			...
			$('#setting').click(function(){
				Shaunz.load('./blogmap/blog_order.html?pageId=${carousel.id}&pageType=tb_carousel');
			});
			...
			$('#blogRelateForm').validate({
				...
				submitHandler:function(form){
					Shaunz.submitForm(form,'./carousel/relate','POST');
				}
	  		});
		});
	</script>
