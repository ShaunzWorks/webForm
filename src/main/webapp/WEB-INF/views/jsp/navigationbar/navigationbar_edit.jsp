...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="navigationbar.title"/></h2>
       	<form id="navigationBarEditForm">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="name" name="name" placeholder="<spring:message code="navigationbar.name.placeHolder"/>" value="${navigationBar.name}"/>
		    ...
		    <div class="input-group col-sm-6">
		    	<select class="form-control" id="type" name="type">
				  <option <c:if test="${navigationBar.type eq 'normal'}">selected</c:if> value="normal"><spring:message code="navigationbar.type.normal"/></option>
				  <option <c:if test="${navigationBar.type eq 'dropdown'}">selected</c:if> value="dropdown"><spring:message code="navigationbar.type.dropdown"/></option>
				</select>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="url" name="url" placeholder="<spring:message code="navigationbar.url.placeHolder"/>" value="${navigationBar.url}"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
          ...
          <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" name="active" id="activeY" value="active" <c:if test="${navigationBar.active eq 'active'}">checked</c:if>/>
				  <label class="form-check-label" for="lockUpY"><spring:message code="common.yes"/></label>
				  <input class="form-check-input" type="radio" name="active" id="activeN" value="inactive" <c:if test="${navigationBar.active eq 'inactive'}">checked</c:if>/>
