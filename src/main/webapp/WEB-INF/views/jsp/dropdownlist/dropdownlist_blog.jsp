...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="user.grant.title"/> ${dropDownList.name}(${dropDownList.id})</h2>
  	...
  	<script type="text/javascript" >
		...
		$(function(){
			...
			$('#setting').click(function(){
				Shaunz.load('./blogmap/blog_order.html?pageId=${dropDownList.id}&pageType=tb_dropdown_list');
			});
			...
			$('#blogRelateForm').validate({
				...
				submitHandler:function(form){
					Shaunz.submitForm(form,'./dropdownlist/relate','POST');
				}
	  		});
		});
	</script>
