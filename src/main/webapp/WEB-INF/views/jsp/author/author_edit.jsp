...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="author.title"/></h2>
       	<form id="authorEditForm">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="name" name="name" placeholder="<spring:message code="author.userNm.placeHolder"/>" value="${author.name}"/>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="<spring:message code="author.email.placeHolder"/>" value="${author.email}"/>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="password" class="form-control" id="pwd" name="pwd" placeholder="<spring:message code="author.password.placeHolder"/>" value="${author.pwd}"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="aliasNm" name="aliasNm" placeholder="<spring:message code="author.aliasNm.placeHolder"/>" value="${author.aliasNm}"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<select class="form-control" id="gender" name="gender">
				  ...
				  <option <c:if test="${user.gender eq 'Male'}">selected</c:if> value="Male"><spring:message code="author.gender.male"/></option>
				  <option <c:if test="${user.gender eq 'Female'}">selected</c:if> value="Female"><spring:message code="author.gender.female"/></option>
				</select>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
