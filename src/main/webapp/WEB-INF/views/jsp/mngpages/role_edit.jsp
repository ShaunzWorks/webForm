...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="role.title"/></h2>
       	<form id="roleEditForm">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="name" name="name" placeholder="<spring:message code="role.name.placeHolder"/>" value="${role.name}"/>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="parentId" name="parentId" aria-describedby="emailHelp" placeholder="<spring:message code="role.parentId.placeHolder"/>" value="${role.parentId}"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
		  ...
		  <div class="form-group row">
            ...
            <div class='input-group date col-sm-6' id='datetimepickerFrom'>
               	<input type="text" class="form-control" id="startTime" name="startTime" placeholder="<spring:message code="role.startTime.placeHolder"/>" value="${role.startTimeString}"/>
          ...
          <div class="form-group row">
            ...
            <div class='input-group date col-sm-6' id='datetimepickerTo'>
               	<input type="text" class="form-control" id="endTime" name="endTime" placeholder="<spring:message code="role.endTime.placeHolder"/>" value="${role.endTimeString}"/>
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
  	...
  	$(function () {
        ...
        $('#roleEditForm').validate({
			...
			submitHandler:function(form){
				Shaunz.submitForm(form,'./role','PUT');
			}
  		});
