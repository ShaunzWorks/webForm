        ...
        $('#accEditForm').validate({
			...
			messages: {
				...
				password: {
					...
					minlength: '<spring:message code="validation.user.password.minlength" arguments="2;" htmlEscape="false" argumentSeparator=";"/>',
					maxlength: '<spring:message code="validation.user.password.minlength" arguments="100;" htmlEscape="false" argumentSeparator=";"/>'
				},
				aliasNm: {
					...
					maxlength: '<spring:message code="validation.user.aliasNm.minlength" arguments="100;" htmlEscape="false" argumentSeparator=";"/>'
				}
			},
