...
<html lang="en">
  <body>
  		<h2 class="sub-header"><spring:message code="button.title"/></h2>
       	<form id="buttonAddForm" enctype="multipart/form-data">
       	  <div class="form-group row">
		    <label for="name" class="col-sm-2 col-form-label"><spring:message code="button.name"/></label>
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="name" name="name" placeholder="<spring:message code="button.name.placeHolder"/>"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="cssClass" name="cssClass" placeholder="<spring:message code="button.cssclass.placeHolder"/>"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="input-group col-sm-6">
		    	<input type="text" class="form-control" id="url" name="url" placeholder="<spring:message code="button.url.placeHolder"/>"/>
		    </div>
		    <div class="col-sm-4">
		    	<span></span>
		    </div>
  	...
  	$(function () {
        $('#buttonAddForm').validate({
			...
			submitHandler:function(form){
				Shaunz.submitForm(form,'./button','POST');
				form.reset();
			}
  		});
