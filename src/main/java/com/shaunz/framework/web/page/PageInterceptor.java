...
public class PageInterceptor implements Interceptor {
    ...
    public void setProperties(Properties properties) {
       this.DB_TYPE = properties.getProperty("DB_TYPE");
    }
     ...
     * @return Oracle数据库的分页查询语句
     */
    private String getPostgresqlPageSql(Page<?> page, StringBuffer sqlBuffer) {
    ...
    /**
     * Count records according to the original SQL
     * @param sql
     * @return
     */
